...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "password_hash", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "google_id", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
        sa.Column(
            "telegram_id", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column(
            "plan_name", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "dns_server", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "method", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "target", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False
        ),
        sa.Column(
